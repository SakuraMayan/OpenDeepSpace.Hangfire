...
namespace OpenDeepSpace.Hangfire
{
    public class HangfireBackgroundJobManager : IBackgroundJobManager
    {
        ...
        public Task<string> EnqueueAsync<TArgs>(TArgs args, string cronExpression, TimeZoneInfo timeZone = null)
        {
        ...
        /// <returns>Unique identifier of a background job.</returns>
        public Task<string> EnqueueAsync<TArgs>(TArgs args, string jobId, string cronExpression, TimeZoneInfo timeZone = null)
        {
        ...
        public Task<string> ContinueJobWith<TArgs>(string parentId, TArgs args)
        {
